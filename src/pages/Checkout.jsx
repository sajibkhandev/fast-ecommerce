...
const Checkout = () => {
  ...
  let breadcrumbdata1 = useSelector((state)=>state.breadcrumb.previousvalue)
  let breadcrumbdata2 = useSelector((state)=>state.breadcrumb.daybeforeyesterday)
      ...
      <Container>
        <div className="py-20">
          <ul className="flex flex-wrap gap-2">
            ...
            <Link to="/">
              <ListItem text={breadcrumbdata2} />
            </Link>
            /
            <Link to="/">
              <ListItem text={breadcrumbdata1} />
            </Link>
          ...
          <div className="md:w-1/2 flex flex-col">
            {billingFields.map((field, index) => (
              <div key={index} className="mx-auto md:mx-0">
                ...
                <Input className="bg-offwhitedark  md:w-4/5  mb-8" />
              </div>
            ))}
          </div>
