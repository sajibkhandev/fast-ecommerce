        ...
        <Flex>
          ...
          <div className="w-5/12">
            <ul className="flex gap-x-12 cursor-pointer">
              ...
              <Link onClick={()=>handleBreadCrumb("Signup")} to="/signup"><ListItem text="Sign Up" /></Link>
          ...
          >
            ...
            <Flex className="gap-x-5">
              ...
              />
              <div className="absolute -top-1 -right-1 bg-yellow-300 w-3 h-3 rounded-full flex justify-center items-center">
                <p className="text-[10px]">{data.length}</p>
              </div>
              </div>
            </Flex>
            {open && (
                  ...
                  <ul className="flex justify-between items-center px-3 py-5 text-sm font-normal border-b border-black/20">
                    <li>
                      <button
                        ...
                        className="flex items-center justify-center w-5 h-5 rounded-full mx-1 bg-gray-100 hover:bg-gray-200 transition cursor-pointer"
                      >
